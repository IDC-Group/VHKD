...
#if defined(NDEBUG)
# error "vhkdCoin cannot be compiled without assertions."
#endif
                     ...
                     ++mi)
                {
                    ...
                    else if (!fMissingInputs2)
                    {
                        ...
                        if (!orphanTx.HasWitness() && !stateDummy.CorruptionPossible()) {
                            ...
                            // See https://github.com/vhkd/vhkd/issues/8279 for details.
                            assert(recentRejects);
...
bool PeerLogicValidation::SendMessages(CNode* pto, std::atomic<bool>& interruptMsgProc)
{
	...
	//else
	//{
	//	printf("(!state.fSyncStarted =%d && !pto->fClient =%d && !fImporting =%d && !fReindex =%d", (!state.fSyncStarted && !pto->fClient && !fImporting && !fReindex);
      // }
