 ...
 * between vhkdd, and vhkd-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/vhkd/vhkd>";
    const std::string URL_WEBSITE = "<https://vhkdcore.org>";
...
/** Sanity checks
 *  Ensure that vhkdCoin is running in a usable environment with all
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single vhkdCoin process is using the data directory.
