...
class BIP66Test(vhkdCoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # vhkdd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and vhkdd produces more specific reject
            # reasons.
