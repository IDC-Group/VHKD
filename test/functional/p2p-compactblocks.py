...
# TestNode: A peer we use to send messages to vhkdd, and store responses.
...
class CompactBlocksTest(vhkdCoinTestFramework):
    ...
    # This test actually causes vhkdd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that vhkdd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for vhkdd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # vhkdd will not send blocktxn responses for blocks whose height is
