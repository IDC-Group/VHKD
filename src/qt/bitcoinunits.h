...
/** vhkdCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class vhkdCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit vhkdCoinUnits(QObject *parent);

    /** vhkdCoin units.
      @note Source: https://en.vhkd.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef vhkdCoinUnits::Unit vhkdCoinUnit;
