...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<vhkdCoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_vhkd-qt -platform xcb      # Linux
//     src/qt/test/test_vhkd-qt -platform windows  # Windows
//     src/qt/test/test_vhkd-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = vhkdCoinUnits::formatWithUnit(unit, balance, false, vhkdCoinUnits::separatorAlways);
    ...
    // Amount input
    vhkdCoinAmountField* amountInput = receiveCoinsDialog.findChild<vhkdCoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: vhkd:")) != -1);
